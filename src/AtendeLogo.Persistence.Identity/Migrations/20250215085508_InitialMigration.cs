...
public partial class InitialMigration : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.AlterDatabase()
            ...
            .Annotation("Npgsql:Enum:business_type", "civil_registry_office")
            ...
            .Annotation("Npgsql:Enum:language", "default,englishk,french,german,italian,portuguese,spanish")
            .Annotation("Npgsql:Enum:password_strength", "empty,medium,strong,weak")
            .Annotation("Npgsql:Enum:tenant_state", "cancelled,closed,new,onboarding,operational,trial")
            .Annotation("Npgsql:Enum:tenant_status", "active,archived,inactive,pending,suspended")
            .Annotation("Npgsql:Enum:tenant_type", "company,individual")
            ...
            .Annotation("Npgsql:Enum:user_status", "anonymous,away,busy,do_not_disturb,offline,online,system,unknown")
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                city = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, collation: "case_accent_insensitive"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, collation: "case_accent_insensitive"),
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    ...
                    onDelete: ReferentialAction.Restrict);
                table.ForeignKey(
                    name: "fk_users_users_tenant_user_id",
