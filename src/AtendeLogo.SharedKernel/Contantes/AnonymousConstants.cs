...
public static class AnonymousConstants
{
    ...
    public static string ClientAnymousSystemSessionToken
        => _clientSystemSessionToken ??= HashHelper.CreateSha256Hash(AnonymousConstants.AnonymousSystemSession_Id);
